...
export const meetingsProcessing = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        // FIX 1: Wrap the AI call in step.run() for durability
        const summary = await step.run("summarize-transcript", async () => {
            ...
            // FIX 2: Handle content being a string OR a ContentPart array
        ...
        // FIX 3: Added return to be explicit about the step result
